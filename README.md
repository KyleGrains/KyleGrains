...
I build small, practical tools around Linux, terminals, reading, packet analysis,
and local AI workflows.

## Current Focus

- Linux systems programming and driver reading
- Packet/media analysis with FFmpeg and Wireshark
- Terminal tools and TUIs
- Reading workflows for technical material
- Local-first automation with Codex
...
I keep a short page of project directions here:

[Project Concepts](concepts.md)

## Contact

Email: kylelsun@gmail.com
